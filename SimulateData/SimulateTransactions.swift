...
extension SimulateData {
    ...
    func simulateNonRecurring() {
        ...
        let mainBankAccount = Account()
        mainBankAccount.referenceTo(coreData: accountsDictionary["bofa"]!)
        
        let homeLoanAccount = Account()
        homeLoanAccount.referenceTo(coreData: accountsDictionary["homeLoan"]!)
        
        let landAccount = Account()
        landAccount.referenceTo(coreData: accountsDictionary["land"]!)
        ...
        stockAccount.referenceTo(coreData: accountsDictionary["stock"]!)
        
        let personalLoanAccount = Account()
    ...
    func simulateAutoLease(yearsHistory:Int) {
        ...
        let autoLeaseAccount = Account()
        autoLeaseAccount.referenceTo(coreData: accountsDictionary["auto leasing"]!)

        let interestAccount = Account()
        interestAccount.referenceTo(coreData: accountsDictionary["interest expense"]!)
    ...
    func simulateIncome(yearsHistory:Int) {
        ...
        let salaryAccount = Account()
        salaryAccount.referenceTo(coreData: accountsDictionary["salary"]!)
        ...
        let interestAccount = Account()
        interestAccount.referenceTo(coreData: accountsDictionary["interest income"]!)
    ...
    func simulateOtherExpense(yearsHistory:Int) {
        ...
        let applianceAccount = Account()
        applianceAccount.referenceTo(coreData: accountsDictionary["appliance"]!)
        ...
        let familyAccount = Account()
        familyAccount.referenceTo(coreData: accountsDictionary["family"]!)
        ...
        let homeAccount = Account()
        homeAccount.referenceTo(coreData: accountsDictionary["home"]!)
        ...
        let carAccount = Account()
        carAccount.referenceTo(coreData: accountsDictionary["car"]!)
    ...
    func simulateUtility(yearsHistory:Int) {
        ...
        subscriptionAccount.referenceTo(coreData: accountsDictionary["subscription"]!)
        ...
        let fuelAccount = Account()
        fuelAccount.referenceTo(coreData: accountsDictionary["fuel"]!)
    ...
    func simulateGrocery(yearsHistory:Int) {
        ...
        let eatoutAccount = Account()
        eatoutAccount.referenceTo(coreData: accountsDictionary["eatout"]!)
